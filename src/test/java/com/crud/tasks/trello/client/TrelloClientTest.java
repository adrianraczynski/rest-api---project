...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getUsername()).thenReturn("adrianraczynski");
    }
    ...
    public void shouldCreateCard () throws URISyntaxException {
        ...
        TrelloBadges badges = new TrelloBadges(1,attachmentsByType);
    ...
    public void shouldReturnEmptyList() throws URISyntaxException {
        //Given
        URI uri = new URI("https://test.com/members/" + trelloConfig.getUsername() + "/boards?key=appKey&token=appToken&fields=name,id&lists=all");
